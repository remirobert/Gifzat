...
- (void)viewDidLoad
{
    ...
    if (self.squareMode) {
        ...
        CGFloat ratio = CGRectGetWidth([UIScreen mainScreen].bounds) / 800;
        CGFloat heightSquare = 1080 * ratio;
        ...
        [self.drawingContainer mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.height.offset(heightSquare);
//            make.width.offset(CGRectGetWidth([UIScreen mainScreen].bounds));
//            make.height.offset(CGRectGetWidth([UIScreen mainScreen].bounds));
