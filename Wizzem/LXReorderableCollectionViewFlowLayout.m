...
LXS_CGPointAdd(CGPoint point1, CGPoint point2) {
    return CGPointMake(point1.x + point2.x, point1.y);
}
#endif
...
- (void)handlePanGesture:(UIPanGestureRecognizer *)gestureRecognizer {
    switch (gestureRecognizer.state) {
        ...
        case UIGestureRecognizerStateChanged: {
            ...
            if ([self.delegate respondsToSelector:@selector(collectionView:layout:draggingAtPoint:)]) {
                [self.delegate collectionView:self.collectionView layout:self draggingAtPoint:viewCenter];
            }
        } break;
        case UIGestureRecognizerStateCancelled:
        case UIGestureRecognizerStateEnded: {
